...
class OrbitControls extends Controls {
	...
	constructor( object, domElement = null ) {
		...
		/** coordinate hooks for rotated (forced-landscape) pages */
		this.clientToLocal = null;
		this.getEventRect = null;
	...
	_updateZoomParameters( x, y ) {
		...
		const p = this.clientToLocal ? this.clientToLocal( x, y ) : { x, y };
		const rect = this.getEventRect ? this.getEventRect() : this.domElement.getBoundingClientRect();
	...
	_handleMouseDownRotate( event ) {
		...
		const p = this.clientToLocal ? this.clientToLocal( event.clientX, event.clientY ) : { x: event.clientX, y: event.clientY };
